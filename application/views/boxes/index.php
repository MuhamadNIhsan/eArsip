          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="<?=site_url('boxes/create')?>" class="btn btn-warning btn-block text-dark font-weight-bold">Create</a></h3>
              </div>
              <!-- /.card-header -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="text-center">
						<a href="<?=site_url('boxes/edit/'.$box->bid)?>" title="Edit Data" class="btn btn-warning text-dark"><i class="fa fa-edit"></i></a>
						<a href="<?=site_url('boxes/delete/'.$box->bcode)?>" title="Delete Data" class="btn btn-warning text-dark"><i class="fa fa-trash"></i></a>
					</td>
                  </tr>
				  <?php endforeach;?>
                  </tbody>
