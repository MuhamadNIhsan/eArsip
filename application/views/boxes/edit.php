			  ...
			  <?=$msg?>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="boxCode" name="boxCode" value="<?=$box->bcode?>">
					<input type="hidden" class="form-control" id="idBox" name="idBox" value="<?=$box->bid?>">
                  </div>
                </div>
                <!-- /.card-body -->
