          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="<?=site_url('category/create')?>" class="btn btn-warning btn-block text-dark font-weight-bold">Create</a></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?=$cat->cname?></td>
					<td><?=$cat->ccolor?><input type="color" value="<?=$cat->ccolor?>" disabled></td>
                    <td class="text-center">
						<a href="<?=site_url('category/edit/'.$cat->cid)?>" title="Edit Data" class="btn btn-warning text-dark"><i class="fa fa-edit"></i></a>
						<a href="<?=site_url('category/delete/'.$cat->cid)?>" title="Delete Data" class="btn btn-warning text-dark"><i class="fa fa-trash"></i></a>
					</td>
                  </tr>
				  <?php endforeach;?>
                  </tbody>
