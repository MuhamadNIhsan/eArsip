			  ...
			  <?=$msg?>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="catName" name="catName" value="<?=$cat->cname?>">
					<input type="hidden" class="form-control" id="idCatName" name="idCatName" value="<?=$cat->cid?>">
                  </div>
                  <div class="form-group">
                    <label for="catColor">Category Color</label>
                    <input type="color" class="form-control" id="catColor" name="catColor" value="<?=$cat->ccolor?>">
                  </div>
                </div>
                <!-- /.card-body -->
