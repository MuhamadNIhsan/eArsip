                ...
                <table id="example1" class="table table-bordered table-striped">
				  ...
				  <tr>
                    ...
                    <td class="text-center">
						<a href="#" id="viewFile" class="btn btn-warning text-dark" title="View Data" data-id="<?=$doc->fid?>"><i class="fa fa-eye"></i></a>
						  ...
						  <div class="modal-content">
							...
							<div class="modal-body">
							  ...
							  <div class="form-group">
								...
								<input type="text" class="form-control" id="bcode" name="bcode" value="" disabled>
							  </div>
							  <div class="form-group">
								<label>Description</label>
								<textarea class="form-control" rows="3" name="fileDesc" id="fileDesc" disabled></textarea>
							  </div>                  
							</div>
...
<script>
	$(document).ready(function(){
		$("a#viewFile").click(function(){
			...
			//console.log("load the file with id" + fileId);	
			$('#modal-view').modal('show');
			$.ajax({
				url: '<?=base_url('index.php/Docs/get_modal/')?>',
				method: "POST",
				data: {id:fileId},
				success: function (response) {
						let obj = JSON.parse(response);
						let file_obj = '<object data="../assets/files/'+ obj[0].fpath+'" type="application/pdf" width="100%" height="800px"><p>It appears you don\'t have a PDF plugin for this browser.No biggie... you can <a href="../assets/files/'+ obj[0].fpath +'">click here to download the PDF file.</a></p></object>';
						$('#obj').html(file_obj);
						$('#fileName').val(obj[0].fname);
						$('#bcode').val(obj[0].bcode);
						$('#fileDesc').val(obj[0].fdesc);
					}
			});
		});
